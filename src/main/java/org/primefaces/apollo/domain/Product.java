...
public class Product implements Serializable {
    ...
    private List<org.primefaces.apollo.domain.Order> orders;
    ...
    public List<org.primefaces.apollo.domain.Order> getOrders() {
        return this.orders;
    }

    public void setOrders(List<org.primefaces.apollo.domain.Order> orders) {
        this.orders = orders;
    }
